...
namespace Quan_ly_nhan_vien
{
    public  class Data
    {
        ...
        {
            List.Add(new FresherExp("Nguyen Thanh Nam", "201", "M", "203 Nguyen Huy Tuong", DateTime.Parse("10/10/2000"), "gioi", "DHBK", DateTime.Parse("10/10/2000"), 4, DateTime.Parse("10/10/2019"), new List<Certificate>()));
